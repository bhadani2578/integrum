    ...
    <div class="pd-x-0">
        <div class="wrap_topbar">
            <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
                <span class="heading-main"><b>{{ $fromStore ? 'Add Project ' : 'Edit Project' }}</b></span>
            </div>
            @if($fromStore == true)
        ...
        <div class="new-site-add-setup consumption-edit-main-part">
            <div class="row">
                <div class="col-md-12 consumption-edit-pro">
                    <form class="form-horizontal mrg-top-40 pdd-right-30 ng-pristine ng-valid add-user-form-setup" action="{{ route('project.update', $project->id) }}" method="POST" enctype='multipart/form-data'>
                        @csrf
                        @method('PUT')
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <label for="site_name" class="control-label">Site Name</label>
                                <input type="text" class="form-control @error('site_name') is-invalid @enderror" id="form-1-1" name="site_name" value="{{old('site_name', $project->site_name) }}" placeholder="Site Name" autocomplete="site_name"  {{ $fromStore ? 'disabled' : '' }} autofocus>
                               <!-- @error('site_name')
                            ...
                            <div class="col-sm-5 weeling_wrap">
                                ...
                                <select name="mapping_id" class="form-control @error('mapping_id') is-invalid @enderror" {{ $fromStore ? 'disabled' : '' }}>
                                <option value="0">Mapping</option>
                                    @if(isset($mapping_list) && count($mapping_list) > 0)
                                        @foreach($mapping_list as $item)
                                            <option {{ old('mapping_id', $project->mapping_id) == $item->id ? 'selected' : '' }} value="{{$item->id}}">{{$item->mapping_name}}</option>
                                        @endforeach
                                    @endif
                                </select>
                               <!-- @error('mapping_id')
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control @error('project_location') is-invalid @enderror" {{ $fromStore ? 'disabled' : '' }} id="form-1-1" name="project_location" value="{{ old('project_location',$project->project_location) }}" placeholder="Project site" required autocomplete="project_location" autofocus>
                            ...
                            <div class="col-sm-5 weeling_wrap">
                                <div class="clipping">
                                    ...
                                    <input type="text" class="form-control @error('clipping') is-invalid @enderror" {{ $fromStore ? 'disabled' : '' }} id="form-1-1" name="clipping" value="{{ old('clipping',$project->clipping) }}" placeholder="Captive" required autocomplete="clipping" autofocus>
                                    <!-- @error('clipping')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="or">
                                    ...
                                    <input type="text"  {{ $fromStore ? 'disabled' : '' }} class="form-control @error('clipping_losses_percentage') is-invalid @enderror" id="form-1-1" name="clipping_value" value="{{ old('clipping_losses_percentage',$project->clipping_value) }}" placeholder="0%" required autocomplete="clipping_losses_percentage" autofocus>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <input type="text" {{ $fromStore ? 'disabled' : '' }} class="form-control @error('total_capacity') is-invalid @enderror" id="form-1-1" name="total_capacity" value="{{ old('total_capacity',$project->total_capacity) }}" placeholder="123456789" required autocomplete="total_capacity" autofocus>
                            ...
                            <div class="col-sm-5 weeling_wrap">
                                <div class="percentage_satisfied">
                                    ...
                                    <input type="text" {{ $fromStore ? 'disabled' : '' }} class="form-control @error('percentage_satisfied') is-invalid @enderror" id="form-1-1" name="percentage_satisfied_value" value="{{ old('percentage_satisfied',$project->percentage_satisfied_value) }}" placeholder="0%" autocomplete="percentage_satisfied" autofocus>
                                ...
                                <input type="text" {{ $fromStore ? 'disabled' : '' }} class="form-control @error('grid_power_replace') is-invalid @enderror" id="form-1-1" name="grid_power" value="{{ old('grid_power_replace',$project->grid_power) }}" placeholder="0%" autocomplete="grid_power_replace" autofocus>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <input type="text" {{ $fromStore ? 'disabled' : '' }} class="form-control @error('green_energy_power') is-invalid @enderror" id="form-1-1" name="green_energy_power" value="{{ old('total_capacity',$project->green_energy_power) }}" placeholder="0%" required autocomplete="total_capacity" autofocus>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <input type="text" {{ $fromStore ? 'disabled' : '' }} class="form-control @error('evacuation_capacity') is-invalid @enderror" id="form-1-1" name="evacuation_capacity" value="{{ old('evacuation_capacity',$project->evacuation_capacity) }}" placeholder="123456789" required autocomplete="evacuation_capacity" autofocus>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <input type="text" {{ $fromStore ? 'disabled' : '' }} class="form-control @error('lapsed_unit') is-invalid @enderror" id="form-1-1" name="lapsed_unit" value="{{ old('lapsed_unit',$project->lapsed_unit) }}" placeholder="0" required autocomplete="lapsed_unit" autofocus>
                               <!-- @error('lapsed_unit')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="col-sm-5 weeling_wrap">
                                ...
                                <input type="text" {{ $fromStore ? 'disabled' : '' }} class="form-control @error('connected_voltage') is-invalid @enderror" id="form-1-1" name="connected_voltage" value="{{ old('connected_voltage',$project->connected_voltage) }}" placeholder="0" autocomplete="connected_voltage" autofocus>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <input type="text" {{ $fromStore ? 'disabled' : '' }} class="form-control @error('wind_cpaex') is-invalid @enderror" id="form-1-1" name="wind_capex" value="{{ old('wind_cpaex',$project->wind_capex) }}" placeholder="0" required autocomplete="wind_cpaex" autofocus>
                               <!-- @error('wind_cpaex')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="col-sm-5 weeling_wrap">
                                ...
                                <input type="text" {{ $fromStore ? 'disabled' : '' }} class="form-control @error('solar_cpaex') is-invalid @enderror" id="form-1-1" name="solar_capex" value="{{ old('solar_cpaex',$project->solar_capex) }}" placeholder="0" autocomplete="solar_cpaex" autofocus>
                                <!-- @error('solar_cpaex')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            @enderror -->
                                ...
                                <input type="text" {{ $fromStore ? 'disabled' : '' }} class="form-control @error('total_cpaex') is-invalid @enderror" id="form-1-1" name="total_capex" value="{{ old('total_cpaex',$project->total_capex) }}" placeholder="0" autocomplete="total_cpaex" autofocus>
                                <!-- @error('total_cpaex')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-md-12 component-btn">
                            <div class="form-group row">
                                <div class="col-md-6">
                                    <input type="submit" {{ $fromStore ? 'disabled' : '' }} class="form-control save-btn-project" id="form-1-1"
                    ...
                    <div class="col-md-12 consumption-edit-pro price-factor">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                ...
                                <input type="checkbox" class="form-control checkbox-toggle" data-target="#electricityTarget"  id="electricity_duty" name="price_component">Electricity Duty</label>                           
                            </div>
                            <div class="col-sm-3">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                ...
                                <input type="checkbox" class="form-control checkbox-toggle" data-target="#crossSubsidyTarget" id="cross_subsidy" name="price_component">Cross Subsidy (* Not Applied on Captive Project)</label>                           
                            </div>
                            <div class="col-sm-3">
                    ...
                    <div class="col-md-12 consumption-edit-pro">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control @error('no_turbines') is-invalid @enderror" id="no_turbines" name="no_turbines" value="{{ old('no_turbines',$project_detail->no_turbines ?? '') }}" >
                                <input type="hidden" class="form-control "  name="project_id" value="{{ $project->id }}" >
                            </div>
                            <div class="col-sm-5 weeling_wrap">
                                <label for="solar_mwp" class="control-label">Solar Mwp</label>
                                <input type="text" class="form-control @error('solar_mwp') is-invalid @enderror" id="solar_mwp" name="solar_mwp" value="{{ old('solar_mwp',$project_detail->solar_mwp ?? '') }}" >
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <label for="dc_ac_ratio" class="control-label">DC to AC ratio</label>
                                <input type="text" class="form-control @error('dc_ac_ratio') is-invalid @enderror" id="dc_ac_ratio" name="dc_ac_ratio" value="{{ old('dc_ac_ratio',$project_detail->dc_ac_ratio ?? '') }}" >
                               
                            </div>
                            <div class="col-sm-5 weeling_wrap">
                                <label for="solar_unit_mwp" class="control-label">Solar gen in units per MWp</label>
                                <input type="text" class="form-control @error('solar_unit_mwp') is-invalid @enderror" id="solar_unit_mwp" name="solar_unit_mwp" value="{{ old('solar_unit_mwp',$project_detail->solar_unit_mwp ?? '') }}" >
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <label for="solar_deration" class="control-label">Solar Deration/Degradation</label>
                                <input type="text" class="form-control @error('solar_deration') is-invalid @enderror" id="solar_deration" name="solar_deration" value="{{ old('solar_deration',$project_detail->solar_deration ?? '') }}" >
                               
                            </div>
                            <div class="col-sm-5 weeling_wrap">
                                <label for="wind_capacity_mws" class="control-label">Wind turbine capacity in MWs</label>
                                <input type="text" class="form-control @error('wind_capacity_mws') is-invalid @enderror" id="wind_capacity_mws" name="wind_capacity_mws" value="{{ old('wind_capacity_mws',$project_detail->wind_capacity_mws ?? '') }}" >
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <label for="wind_gen_unit_turbine" class="control-label">Wind gen in units per turbine</label>
                                <input type="text" class="form-control @error('wind_gen_unit_turbine') is-invalid @enderror" id="wind_gen_unit_turbine" name="wind_gen_unit_turbine" value="{{ old('wind_gen_unit_turbine',$project_detail->wind_gen_unit_turbine ?? '') }}" >
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control @error('total_gen') is-invalid @enderror" id="total_gen" name="total_gen" value="{{ old('total_gen',$project_detail->total_gen ?? '') }}" >
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control @error('solar_capex') is-invalid @enderror" id="solar_capex" name="solar_capex" value="{{ old('solar_capex',$project_detail->solar_capex ?? '') }}" >
                               
                            </div>
                            <div class="col-sm-5 weeling_wrap">
                                <label for="wind_capex" class="control-label">Wind Capex per MW</label>
                                <input type="text" class="form-control @error('wind_capex') is-invalid @enderror" id="wind_capex" name="wind_capex" value="{{ old('wind_capex',$project_detail->wind_capex ?? '') }}" >
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <label for="total_capex" class="control-label">Total Capex</label>
                                <input type="text" class="form-control @error('total_capex') is-invalid @enderror" id="total_capex" name="total_capex" value="{{ old('total_capex',$project_detail->total_capex ?? '') }}" >
                    ...
                    <div class="col-md-12 consumption-edit-pro">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control @error('gst') is-invalid @enderror" id="gst" name="gst" value="{{ old('gst',$loan->gst ?? '') }}" placeholder="GST"  >
                                <input type="hidden" class="form-control "  name="project_id" value="{{ $project->id }}" >
                               
                            </div>
                            <div class="col-sm-3 weeling_wrap ">
                                <input type="text" class="form-control @error('income_tax') is-invalid @enderror" id="income_tax" name="income_tax" value="{{ old('income_tax', $loan->income_tax ?? '') }}" placeholder="Income Tax" >
                                
                            </div>
                            <div class="col-sm-3 weeling_wrap ">
                            <input type="text" class="form-control @error('cash_equity') is-invalid @enderror" id="cash_equity" name="cash_equity" value="{{ old('cash_equity',$loan->cash_equity ?? '') }}" placeholder="Cash Equity" >
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <label for="debt" class="control-label">Debt</label>
                                <input type="text" class="form-control @error('debt') is-invalid @enderror" id="debt" name="debt" value="{{ old('debt', $loan->debt ?? '') }}" >
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control @error('total_fund') is-invalid @enderror" id="total_fund" name="total_fund" value="{{ old('total_fund',$loan->total_fund ?? '') }}" >
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control @error('rate_of_interest') is-invalid @enderror" id="rate_of_interest" name="rate_of_interest" value="{{ old('rate_of_interest',$loan->rate_of_interest ?? '') }}" >                               
                            </div>
                            <div class="col-sm-5 weeling_wrap">
                                <label for="repayment_period" class="control-label">Repayment Period</label>
                                <input type="text" class="form-control @error('repayment_period') is-invalid @enderror" id="repayment_period" name="repayment_period" value="{{ old('repayment_period',$loan->repayment_period ?? '') }}" >
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <label for="moratorium" class="control-label">Moratorium</label>
                                <input type="text" class="form-control @error('moratorium') is-invalid @enderror" id="moratorium" name="moratorium" value="{{ old('moratorium',$loan->moratorium ?? '') }}" >                               
                            </div>
                            <div class="col-sm-5 weeling_wrap">
                                <label for="tax_rate" class="control-label">Tax Rate</label>
                                <input type="text" class="form-control @error('tax_rate') is-invalid @enderror" id="tax_rate" name="tax_rate" value="{{ old('tax_rate', $loan->tax_rate ?? '') }}" >
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <label for="depreciation_rate" class="control-label">Depreciation Rate</label>
                                <input type="text" class="form-control @error('depreciation_rate') is-invalid @enderror" id="depreciation_rate" name="depreciation_rate" value="{{ old('depreciation_rate', $loan->depreciation_rate ?? '') }}" >
                               
                            </div>
                            <div class="col-sm-5 weeling_wrap">
                                <label for="addl_depreciation_rate" class="control-label">Addl. Depreciation Rate</label>
                                <input type="text" class="form-control @error('addl_depreciation_rate') is-invalid @enderror" id="addl_depreciation_rate" name="addl_depreciation_rate" value="{{ old('addl_depreciation_rate',$loan->addl_depreciation_rate ?? '') }}" >
                            </div>
                        </div>
                    ...
                    <div class="col-md-12 consumption-edit-pro">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control @error('solar_maintenance') is-invalid @enderror" id="solar_maintenance" name="solar_maintenance" value="{{ old('solar_maintenance',$annual_maintenance->solar_maintenance ?? '') }}" >
                                <input type="hidden" class="form-control "  name="project_id" value="{{ $project->id }}" >
                            </div>
                            <div class="col-sm-5 weeling_wrap">
                                <label for="soalr_free" class="control-label">Solar Free O&M</label>
                                <input type="text" class="form-control @error('soalr_free') is-invalid @enderror" id="soalr_free" name="soalr_free" value="{{ old('soalr_free',$annual_maintenance->soalr_free ?? '') }}" >
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control @error('solar_escalation') is-invalid @enderror" id="solar_escalation" name="solar_escalation" value="{{ old('solar_escalation',$annual_maintenance->solar_escalation ?? '') }}" >
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control @error('wind_maintenance') is-invalid @enderror" id="wind_maintenance" name="wind_maintenance" value="{{ old('wind_maintenance',$annual_maintenance->wind_maintenance ?? '') }}" >                               
                            </div>
                            <div class="col-sm-5 weeling_wrap">
                                <label for="wind_free" class="control-label">Wind Free O&M</label>
                                <input type="text" class="form-control @error('wind_free') is-invalid @enderror" id="wind_free" name="wind_free" value="{{ old('wind_free',$annual_maintenance->wind_free ?? '') }}" >
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <label for="wind_escalation" class="control-label">Wind O&M Escalation</label>
                                <input type="text" class="form-control @error('wind_escalation') is-invalid @enderror" id="wind_escalation" name="wind_escalation" value="{{ old('wind_escalation',$annual_maintenance->wind_escalation ?? '') }}" >                               
                            </div>
                        ...
                        <div class="form-group row">                            
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control @error('bop_maintenance') is-invalid @enderror" id="bop_maintenance" name="bop_maintenance" value="{{ old('bop_maintenance',$annual_maintenance->bop_maintenance ?? '') }}" >
                            </div>
                            <div class="col-sm-5 weeling_wrap">
                            <label for="bop_free" class="control-label">BOP Free O&M</label>
                                <input type="text" class="form-control @error('bop_free') is-invalid @enderror" id="bop_free" name="bop_free" value="{{ old('bop_free',$annual_maintenance->bop_free ?? '') }}" >
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control @error('bop_escalation') is-invalid @enderror" id="bop_escalation" name="bop_escalation" value="{{ old('bop_escalation',$annual_maintenance->bop_escalation ?? '') }}" >
                            </div>
                        </div>
                    ...
                    <div class="col-md-12 consumption-edit-pro">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control @error('insurance') is-invalid @enderror" id="insurance" name="insurance" value="{{ old('insurance',$insurance->insurance ?? '') }}" >
                                <input type="hidden" class="form-control "  name="project_id" value="{{ $project->id }}" >
                            </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <label for="total_capex" class="control-label">Total Capex</label>
                                <input type="text" class="form-control @error('total_capex') is-invalid @enderror" id="total_capex" name="total_capex" value="{{ old('total_capex',$insurance->total_capex ?? '') }}" >
                    ...
                    <div class="col-md-12 consumption-edit-pro">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control @error('lapsed_unit') is-invalid @enderror" id="lapsed_unit" name="lapsed_unit" value="{{ old('lapsed_unit',$recovery->lapsed_unit ?? '') }}" >
                                <input type="hidden" class="form-control "  name="project_id" value="{{ $project->id }}" >
                            </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control @error('recovery_unit') is-invalid @enderror" id="recovery_unit" name="recovery_unit" value="{{ old('recovery_unit',$recovery->recovery_unit ?? '') }}" >
                    ...
                    <div class="col-md-12 consumption-edit-pro">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control @error('ctu_charge') is-invalid @enderror" id="ctu_charge" name="ctu_charge" value="{{ old('ctu_charge',$transmission->ctu_charge ?? '') }}" >
                                <input type="hidden" class="form-control "  name="project_id" value="{{ $project->id }}" >
                            </div>
                            <div class="col-sm-5 weeling_wrap">
                                <label for="ctu_losses" class="control-label">CTU Transmission losses</label>
                                <input type="text" class="form-control @error('ctu_losses') is-invalid @enderror" id="ctu_losses" name="ctu_losses" value="{{ old('ctu_losses',$transmission->ctu_losses ?? '') }}" >
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <label for="stu_charge" class="control-label">STU Transmission charges</label>
                                <input type="text" class="form-control @error('stu_charge') is-invalid @enderror" id="stu_charge" name="stu_charge" value="{{ old('stu_charge',$transmission->stu_charge ?? '') }}" >
                               
                            </div>
                            <div class="col-sm-5 weeling_wrap">
                                <label for="stu_losses" class="control-label">STU transmission losses</label>
                                <input type="text" class="form-control @error('stu_losses') is-invalid @enderror" id="stu_losses" name="stu_losses" value="{{ old('stu_losses', $transmission->stu_losses ?? '') }}" >
                            </div>
                        </div>
                        <div class="col-md-12 component-btn">
                            <div class="form-group row">
                    ...
                    <div class="col-md-12 consumption-edit-pro">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control @error('wheeling_charge_unit') is-invalid @enderror" id="wheeling_charge_unit" name="wheeling_charge_unit" value="{{ old('wheeling_charge_unit',$wheeling_charge->wheeling_charge_unit ?? '') }}" >
                                <input type="hidden" class="form-control "  name="project_id" value="{{ $project->id }}" >
                            </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control @error('discom_charge') is-invalid @enderror" id="discom_charge" name="discom_charge" value="{{ old('discom_charge',$wheeling_charge->discom_charge ?? '') }}" >
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control @error('discom_losses') is-invalid @enderror" id="discom_losses" name="discom_losses" value="{{ old('discom_losses',$wheeling_charge->discom_losses ?? '') }}" >
                    ...
                    <div class="col-md-12 consumption-edit-pro">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control @error('banking_basis') is-invalid @enderror" id="banking_basis" name="banking_basis" value="{{ old('banking_basis',$banking->banking_basis ?? '') }}" >
                                <input type="hidden" class="form-control "  name="project_id" value="{{ $project->id }}" >
                            </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control @error('banking_charges') is-invalid @enderror" id="banking_charges" name="banking_charges" value="{{ old('banking_charges',$banking->banking_charges ?? '') }}" >
                    ...
                    <div class="col-md-12 consumption-edit-pro">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control @error('peak_banking_basis') is-invalid @enderror" id="peak_banking_basis" name="peak_banking_basis" value="{{ old('peak_banking_basis',$peak_banking->peak_banking_basis ?? '') }}" >
                                <input type="hidden" class="form-control "  name="project_id" value="{{ $project->id }}" >
                            </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control @error('peak_banking_charges') is-invalid @enderror" id="peak_banking_charges" name="peak_banking_charges" value="{{ old('peak_banking_charges',$peak_banking->peak_banking_charges ?? '') }}" >
                    ...
                    <div class="col-md-12 consumption-edit-pro">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control @error('net_unit') is-invalid @enderror" id="net_unit" name="net_unit" value="{{ old('net_unit',$electricity->net_unit ?? '') }}" >
                                <input type="hidden" class="form-control "  name="project_id" value="{{ $project->id }}" >
                            </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control @error('electricity_unit') is-invalid @enderror" id="electricity_unit" name="electricity_unit" value="{{ old('electricity_unit',$electricity->electricity_unit ?? '') }}" >
...
<script>
    $(document).ready(function() {
      // Assuming you have a button element with an id="scrollButton" in your HTML
      window.onscroll = function() {
  var scrollTop = window.scrollY;
  console.log('Top position:', scrollTop);
};
    });
  </script>
@endsection
