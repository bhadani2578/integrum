    ...
    <div class="container">
        ...
        <div class="new-site-add-setup">
            <div class="row mg-t-40">
                <div class="col-md-9">
                    <form class="form-horizontal mrg-top-40 pdd-right-30 ng-pristine ng-valid add-user-form-setup" action="{{ route('user.update', $user_details->id) }}" method="POST" enctype='multipart/form-data'>
                    @csrf
                    @method('PUT')
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12">
                                ...
                                <div class="custom-file">
                                    ...
                                    <img src="{{url('public/' .$user_details->image)}}">
                                    @endif
